...
* Wait for staff's **confirmation** before continuing. If they approve, please **go ahead and open the spoofer, and click the SPOOF button.**
...
```
GET https://perm-1.gitbook.io/blitz-perm/spoofing/normal-spoofing.md?ask=<question>
```
