...
{% hint style="danger" %}
***Please note, it MUST be Windows 10 for the media creation drive, not Windows 11. You are allowed to upgrade to Windows 11 via Windows Update AFTER you have fully reinstalled Windows 10 into your RAID array.***
{% endhint %}
...
10. Go back and select **Create Array**.
11. The RAID type should default to **Volume** (leave it as is, if it is not on Volume, change it to be Volume. If Volume is not available at all, set it to RAIDABLE).
12. Go into **Select Physical Disks**.
13. Enable your disk and click **Apply Changes**.
14. Click **Create Array** at the bottom. (if you have multiple disks, repeat steps 5-14 for each disk you have)
15. Boot from the Windows USB by setting it to #1 in Boot Priority, then saving and exiting.
16. When you reach the partitions screen, there will be allocated disks if you are NVMe (**Disk 0 Partition 1 and/or Disk 1 Partition 1 depending on the amount of disks you have**). Select it, click **Delete**, and make it **Unallocated** (**Disk 0 Unallocated**).
17. Follow these driver installation steps (NOTE: DO NOT UNTICK THE CHECKBOX THAT SAYS "Hide drivers that are incompatible with this system"):
...
11. Go back and select **Create Array**. (if you have multiple disks, repeat steps 8-13 for each disk you have)
...
15. Click **Create Array** at the bottom. (if you have multiple disks, repeat steps 5-15 for each disk you have)
...
```
GET https://perm-1.gitbook.io/blitz-perm/preparation/raid-reinstallation-amd.md?ask=<question>
```
